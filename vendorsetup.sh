# Device
git clone --depth=1 https://github.com/ArrowOS-Devices/android_kernel_xiaomi_sm6250.git -b arrow-12.1 kernel/xiaomi/sm6250
git clone https://github.com/SonalSingh18/android_device_xiaomi_sm6250-common.git -b caf device/xiaomi/sm6250-common
git clone https://github.com/ArrowOS-Devices/android_vendor_xiaomi_miatoll.git -b arrow-12.1 vendor/xiaomi/miatoll
git clone https://github.com/SonalSingh18/android_vendor_xiaomi_sm6250-common.git -b caf vendor/xiaomi/sm6250-common
git clone https://github.com/ArrowOS-Devices/android_device_xiaomi_extras.git -b arrow-12.0 device/xiaomi/extras
git clone https://github.com/SonalSingh18/android_packages_apps_GCamGOPrebuilt.git -b arrow-12.0 packages/apps/GCamGOPrebuilt
